...
export class ManagerStaffController {
  ...
  async createManagerStaff(
    @Body() managerStaffDto: ManagerPayloadDto,
  ): Promise<ManagerStaffDto> {
    return this.managerStaffService.createManagerStaff(managerStaffDto);
  }
  ...
  async createMultipleManagerStaff(
    @Body(new ParseArrayPipe({ items: ManagerPayloadDto }))
    managerStaffDtos: ManagerPayloadDto[],
  ): Promise<ManagerStaffDto[]> {
  ...
  async updateManagerStaff(
    ...
    return this.managerStaffService.updateManagerStaff(id, managerStaffDto);
  }
  ...
  async deleteManagerStaff(
    ...
    await this.managerStaffService.deleteManagerStaff(id);
  }
}
